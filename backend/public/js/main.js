...
class PostService {
    constructor(http) {
        ...
        this.http.get("/api").subscribe((posts) => {
            for (let p of posts) {
                this.posts.push(new _post__WEBPACK_IMPORTED_MODULE_2__["Post"](p.nome, p.email, p.titulo, p.subtitulo, p.mensagem, p.arquivo, p.id, p.likes));
            }
        });
    }
    salvar(post, file) {
...
PostComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PostComponent, selectors: [["app-post"]], inputs: { post: "post" }, decls: 17, vars: 5, consts: [["fxFlex", "", 1, "card"], ["mat-card-avatar", "", 1, "example-header-image"], ["mat-card-image", "", "alt", "", 3, "src"], ["mat-button", "", "color", "primary", 3, "click"], ["mat-button", ""], ["color", "warn", "matBadgePosition", "above before", "matBadgeColor", "accent", "matBadgeOverlap", "false", 3, "matBadge", 4, "ngIf"], ["color", "warn", "matBadgePosition", "above before", "matBadgeColor", "accent", "matBadgeOverlap", "false", 3, "matBadge"]], template: function PostComponent_Template(rf, ctx) { if (rf & 1) {
